                    ...
                    <div class="card col-4">
                        <div class="p-6 text-gray-900">
                            ...
                            @if($cart && $cart->courses->contains($course))
                                <a href="{{route('cart.delete' , $course)}}" class="btn btn-sm btn-danger">Remove From Cart</a>
                            @else
                            <a href="{{route('cart.store', $course)}}" class="btn btn-sm btn-primary">Add To Cart</a>
                            @endif
                        </div>
                    </div>
                @endforeach
